...
import { Card } from '../../../components/WorkerComponents/WorkerComponents';
...
const jobCategories = route.params.item.skill; //import the skills from the route of the previous screen
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------
          ...
          <FlatList
              ...
              data = {[
                        ...
                        },
                        {
                            ...
                            rating: 3,
                            description:"This is the description lorem s",
