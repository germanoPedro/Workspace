...
// import styling component
    ...
    return(
        <TouchableOpacity style = {MessageButton} onPress={props.onPress}>
            <MaterialCommunityIcons name = "message-outline" size = {16} style = {{ color : colors.white}} color = { colors.text }/>
        </TouchableOpacity>
    );
};
...
function clientViewWorkerProfile({ navigation, route }){
// import styling component
...
let name = route.params.item.name;
let initials = getInitials(name);
    const [Available,setAvailable] = useState(route.params.item.available); //to show the "Read more & Less Line"
        ...
        >
            ...
            >
              <View style = {{flexDirection: 'row', alignItems: 'center', padding: 15,}}>
                ...
                <View style = {{flexDirection:'column' , padding:10}}>
                    <Text style = { profileName }>{ route.params.item.name }</Text>

                    <Text style = { profileLocation}>{ route.params.item.location }</Text>

                    <Text style = { profileLocation}>{ route.params.item.travelDistance} Traveling Radius</Text>
                    {/*Buttons view*/}
          ...
          <View style = {profileStatsView}>
              ...
              >
                ...
                >
                  <View style = {cardView}>
                    <Text style = {{color: colors.white}}  >{ route.params.item.totalJobs } </Text>
              ...
              <TouchableOpacity style = { cardButton }>
                <View style = {cardView}>
                  <Text style = {{color:'#2185F5'}} >{ route.params.item.trusters } </Text>
                    <Text style = { subTitle }> Trusters </Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity style = { cardButton }>
                <View style = { cardView }>
                  <Text style = {{color : colors.warning}} >{ route.params.item.reporters } </Text>
            ...
            <View style = { availableView }>
                ...
                <Text style = { memberDurationText }>A member since {route.params.item.time}</Text>
                <ScrollView
                style = {skillsListView }
                horizontal = {true}
                >
                {
                    route.params.item.skills.map((l,i)=>(
             ...
             <View style = {{ flex:1, flexDirection: "column", alignItems:"center", justifyContent:"center", paddingHorizontal: 26, paddingBottom: 36, marginHorizontal: 5 }}>
               ...
               <View style = {{ paddingBottom : 20 }}>
                <Details style = {descriptionText} details = { route.params.item.description } lines = {3}/>
               </View>
             </View>
        </ScrollView>
        <BottomDrawer
...
export default React.memo(clientViewWorkerProfile, ReviewCard);
