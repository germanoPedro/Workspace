...
const SettingsScreen = () => {
  ...
  const User = {
    name: "John Doe",
    username: "@j_doe",
    description: "I am a freelance web developer, I will make any design come to life with highly effecient, fast and clean code. Make your ecommerce, business, landing page, web app"
  };
